 ...
 */
public class HeadOutNGramModel implements NGramModel {
    ...
    public HeadOutNGramModel(NGram.NGramType nGramType, int level)
            throws UnsupposedArgumentException, UnsupposedTypeException {
        this.nGramBaseType = nGramType;
        this.level         = level;
        initialze();
    ...
    public double getProbability(List<String> prev, String next)
        ...
        HeadOutNGramProbabilityEstimator estimator = null;
    ...
    public static class HeadOutNGramProbabilityEstimator implements NGramProbabilityEstimator {
        ...
        @Override
        public void computeStatistics() throws UnsupposedArgumentException {
        ...
        @Override
        public int getN() {
            return trainingProcessor.getNGramFactory().getStorage().getWordCount();
        }
